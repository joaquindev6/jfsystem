...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="row">
      <div class="col-lg-3">
        <a class="btn btn-primary me-2 mb-4" href="<%=request.getContextPath()%>/control/usuarios/formulario">Nuevo Usuario</a>
        <a class="btn btn-secondary me-2 mb-4" href="<%=request.getContextPath()%>/control/usuarios/reporte-de-usuarios.pdf" target="_blank">Imprimir PDF</a>
      </div>
    </div>
                  ...
                  <table id="table" class="table table-hover">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><%=u.getEmail()%></td>
                        <td><%=u.getDocumentType().getNombre()%></td>
                        <td class="text-center"><%=u.getNrodocu()%></td>
                        <td class="text-center"><%=u.getUsername()%></td>
                        <td class="text-center"><%=u.getUserRole().getDescripcion()%></td>
                        <td class="text-center">
                          <div class="d-flex justify-content-center align-items-center">
                            <a class="btn btn-success me-2" href="<%=request.getContextPath()%>/control/usuarios/data-show?id=<%=u.getId()%>"><i class="bi bi-pencil-fill"></i></a>
                            <a class="btn btn-danger" href="<%=request.getContextPath()%>/control/usuarios/data-show?idDelete=<%=u.getId()%>"
