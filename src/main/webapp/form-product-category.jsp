...
<head>
  ...
  <title>Registro de Categoría | JC System</title>
    ...
    <section class="section">
      <div class="row justify-content-center">
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              <form class="row g-3 needs-validation mt-2" action="<%=request.getContextPath()%>/inventario/categoria-producto/formulario/save" method="post" novalidate>
                <div class="col-md-12">
                  ...
                  <div class="invalid-feedback">Porfavor ingrese el nombre de la categoría.</div>
                </div>
                <div class="col-md-12">
                ...
                <div class="text-end">
                  <a class="btn btn-danger me-2" href="<%=request.getContextPath()%>/inventario/categoria-producto">Volver</a>
