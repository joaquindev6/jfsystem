...
<%@ page import="com.company.app.models.Product" %>
...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="row">
      <div class="col-lg-3">
        <a class="btn btn-primary me-2 mb-4" href="<%=request.getContextPath()%>/inventario/productos/formulario">Nuevo Producto</a>
        <a class="btn btn-secondary me-2 mb-4" href="<%=request.getContextPath()%>/inventario/productos/reporte-de-productos.pdf" target="_blank">Imprimir PDF</a>
      </div>
    </div>
                  ...
                  <table id="table" class="table table-hover">
                    ...
                    <% for (Product p: products) { %>
                      <tr>
                        ...
                        <td><%=p.getNombre()%></td>
                        <td><%=p.getMarkProduct().getNombre()%></td>
                        <td><%=p.getCategoryProduct().getNombre()%></td>
                        <td class="text-center"><%=p.getUnidMed().getNombre()%></td>
                        <td class="text-center"><%=p.getStock()%></td>
                        <td class="text-end"><%=p.getPrecio()%></td>
                        <td class="text-center"><%=p.getFecharegi()%></td>
                        <td class="text-center">
                          <div class="d-flex justify-content-center align-items-center">
                            <a class="btn btn-success me-2" href="<%=request.getContextPath()%>/inventario/productos/data-show?id=<%=p.getId()%>"><i class="bi bi-pencil-fill"></i></a>
                            <a class="btn btn-danger" href="<%=request.getContextPath()%>/inventario/productos/data-show?idDelete=<%=p.getId()%>"
