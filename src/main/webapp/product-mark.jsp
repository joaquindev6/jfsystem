...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="row">
      <div class="col-lg-3">
        <a class="btn btn-primary me-2 mb-4" href="<%=request.getContextPath()%>/inventario/marca-producto/formulario">Nueva Marca</a>
        <a class="btn btn-secondary me-2 mb-4" href="<%=request.getContextPath()%>/inventario/marca-producto/reporte-de-marcas-de-productos.pdf" target="_blank">Imprimir PDF</a>
      </div>
    </div>
                ...
                <div class="col-lg-12 overflow-hidden">
                  ...
                  <table id="table" class="table table-hover">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td class="text-center"><%=m.getId()%></td>
                        <td><%=m.getNombre()%></td>
                        <td><%=m.getDescripcion()%></td>
                        <td class="text-center">
                          <div class="d-flex justify-content-center align-items-center">
                            <a class="btn btn-success me-2" href="<%=request.getContextPath()%>/inventario/marca-producto/data-show?id=<%=m.getId()%>"><i class="bi bi-pencil-fill"></i></a>
                            <a class="btn btn-danger" href="<%=request.getContextPath()%>/inventario/marca-producto/data-show?idDelete=<%=m.getId()%>"
